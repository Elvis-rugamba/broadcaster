...
describe('Users create red-flag record, edit and delete their red-flags', () => {
  ...
  describe('GET /red-flags/<red-flag-id>', () => {
    it('it should fetch a specific ​red-flag​ record', (done) => {
      chai.request(server)
        .get(`/red-flags/${redFlags[0].id}`)
        .set('Authorization', `Bearer ${token}`)
        .then((res) => {
          expect(res).to.have.status(200);
          expect(res.body).to.be.an('object');
  ...
  describe('PATCH /red-flags/<red-flag-id>', () => {
    it('it should update the ​red-flag​ record', (done) => {
      chai.request(server)
        .patch(`/red-flags/${redFlags[0].id}`)
        .set('Authorization', `Bearer ${token}`)
        .field('title', 'Updated title test')
        .field('type', 'intervention')
  ...
  describe('PATCH /red-flags/<red-flag-id>/location', () => {
    it('it should update the ​red-flag​ record\'s location', (done) => {
      chai.request(server)
        .patch(`/red-flags/${redFlags[0].id}/location`)
        .set('Authorization', `Bearer ${token}`)
    ...
    it('it should not update the other user\'s red-flag record\'s location', (done) => {
      chai.request(server)
        .patch(`/red-flags/${redFlags[2].id}/location`)
        .set('Authorization', `Bearer ${token}`)
        .send({ location: '50.5556, -45.56s44' })
        .then((res) => {
          expect(res).to.have.status(401);
  ...
  describe('PATCH /red-flags/<red-flag-id>/comment', () => {
    it('it should update the ​red-flag​ record\'s comment', (done) => {
      chai.request(server)
        .patch(`/red-flags/${redFlags[0].id}/comment`)
        .set('Authorization', `Bearer ${token}`)
    ...
    it('it should not update the other user\'s red-flag record\'s comment', (done) => {
      chai.request(server)
        .patch(`/red-flags/${redFlags[2].id}/comment`)
        .set('Authorization', `Bearer ${token}`)
        .send({ comment: 'Updated comment' })
        .then((res) => {
          expect(res).to.have.status(401);
  ...
  describe('Delete /red-flags/<red-flag-id>', () => {
    beforeEach((done) => {
    ...
    it('it should delete the ​red-flag​ record', (done) => {
      chai.request(server)
        .delete(`/red-flags/${redFlags[0].id}`)
        .set('Authorization', `Bearer ${token}`)
        .then((res) => {
          expect(res).to.have.status(200);
          expect(res.body).to.be.an('object');
    ...
    it('it should not delete the other user\'s ​red-flag​ record', (done) => {
      chai.request(server)
        .delete(`/red-flags/${redFlags[1].id}`)
        .set('Authorization', `Bearer ${token}`)
        .then((res) => {
          expect(res).to.have.status(401);
          expect(res.body).to.be.an('object');
...
describe('Admin change red-flag record\'s status and list all the red-flags created by all users', () => {
  ...
  describe('PATCH /red-flags/<red-flag-id>/status', () => {
    it('it should update the ​red-flag​ record\'s status', (done) => {
      chai.request(server)
        .patch(`/red-flags/${redFlags[0].id}/status`)
        .set('Authorization', `Bearer ${token}`)
